(function () {
  ...
  const defaultCallSatisfactionStr = '暫時沒有了';
  ...
  function createBotMsg(str){
    const loadingEl = createBotLoading(); // 先放 loading    
